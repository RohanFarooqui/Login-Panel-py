...
from Scripts.side_function import remove_space
#etc
...
class Sign_up(ttk.Frame):
    ...
    def init_gui(self):
        ...
        self.button =  ttk.Button(self.root,text=" Close ",width="14",command= self.on_quit).place(relx=0.36, rely=0.82 ,anchor=NW)
